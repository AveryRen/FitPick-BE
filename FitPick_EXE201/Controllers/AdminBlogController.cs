...
namespace FitPick_EXE201.Controllers
{
    ...
    public class AdminBlogController : ControllerBase
    {
        ...
        /// <summary>?? L?y danh sách blog (phân trang + l?c + s?p x?p)</summary>
        [HttpGet]
            ...
            [FromQuery] int pageSize = 10)
        {
            ...
            return Ok(ApiResponse<PagedResult<BlogResponse>>.SuccessResponse(result, "L?y danh sách blog thành công"));
        }
        ...
        public async Task<ActionResult<ApiResponse<BlogResponse>>> GetById(int id)
        {
            ...
            if (blog == null)
                return NotFound(ApiResponse<string>.ErrorResponse(
                    new List<string> { "Không tìm th?y blog" }, "Th?t b?i"));

            return Ok(ApiResponse<BlogResponse>.SuccessResponse(ToDto(blog), "L?y blog thành công"));
        }
            ...
            [FromForm] List<IFormFile>? files)
        {
            ...
            return Ok(ApiResponse<string>.SuccessResponse("OK", "T?o blog thành công"));
        }
            ...
            [FromForm] List<IFormFile>? files)
        {
            ...
            return Ok(ApiResponse<string>.SuccessResponse("OK", "C?p nh?t blog thành công"));
        }

        /// <summary>??? Xóa blog</summary>
        [HttpDelete("{id:int}")]
        [ProducesResponseType(typeof(ApiResponse<string>), 200)]
        [ProducesResponseType(typeof(ApiResponse<string>), 404)]
