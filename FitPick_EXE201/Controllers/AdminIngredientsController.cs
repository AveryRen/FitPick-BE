...
namespace FitPick_EXE201.Controllers
{
    ...
    public class AdminIngredientsController : ControllerBase
    {
            ...
            [FromQuery] bool onlyActive = true)
        {
            ...
            return Ok(ApiResponse<IEnumerable<Ingredient>>.SuccessResponse(ingredients, "L?y danh sách nguyên li?u thành công"));
        }
        ...
        public async Task<ActionResult<ApiResponse<Ingredient>>> GetById(int id)
        {
            ...
            if (ingredient == null)
                return NotFound(ApiResponse<Ingredient>.ErrorResponse(
                    new List<string> { "Nguyên li?u không t?n t?i" }, "Không tìm th?y"));

            return Ok(ApiResponse<Ingredient>.SuccessResponse(ingredient, "L?y nguyên li?u thành công"));
        }
        ...
        public async Task<ActionResult<ApiResponse<Ingredient>>> Create([FromBody] IngredientCreateDto dto)
        {
            if (!ModelState.IsValid)
            {
                ...
                return BadRequest(ApiResponse<Ingredient>.ErrorResponse(errors, "D? li?u không h?p l?"));
            }
            ...
            return CreatedAtAction(
                ...
                ApiResponse<Ingredient>.SuccessResponse(created, "T?o nguyên li?u thành công")
            );
        }
        ...
        public async Task<ActionResult<ApiResponse<Ingredient>>> Update(int id, [FromBody] IngredientUpdateDto dto)
        {
            ...
            return Ok(ApiResponse<Ingredient>.SuccessResponse(updated, "C?p nh?t nguyên li?u thành công"));
        }
        ...
        public async Task<ActionResult<ApiResponse<string>>> Delete(int id)
        {
            ...
            return Ok(ApiResponse<string>.SuccessResponse("Ðã xóa thành công", "Xóa nguyên li?u thành công"));
        }
    }
}
