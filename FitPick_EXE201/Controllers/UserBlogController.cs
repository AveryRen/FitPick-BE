...
namespace FitPick_EXE201.Controllers
{
    ...
    public class UserBlogController : ControllerBase
    {
              ...
              [FromQuery] int pageSize = 10)
        {
            ...
            // Tr? v? d? li?u kèm thông tin phân trang
            var result = new
            {
            ...
            return Ok(ApiResponse<object>.SuccessResponse(result, "L?y danh sách blog thành công"));
        }
        ...
        public async Task<IActionResult> GetById(int id)
        {
            ...
            if (blogEntity == null)
            {
                return NotFound(ApiResponse<BlogResponse>.ErrorResponse(
                    new List<string> { "Không tìm th?y blog" },
                    "Blog không t?n t?i"
                ));
            }
            ...
            return Ok(ApiResponse<BlogResponse>.SuccessResponse(blogDto, "L?y blog thành công"));
        }
            ...
            [FromForm] List<IFormFile>? files)
        {
            ...
            if (!int.TryParse(userIdClaim, out int userId))
            {
                return Unauthorized(ApiResponse<string>.ErrorResponse(
                    new List<string> { "Không xác d?nh du?c ngu?i dùng" },
                    "T?o blog th?t b?i"
                ));
            }
            ...
            return CreatedAtAction(nameof(GetById), new { id = created.Postid },
                ApiResponse<BlogResponse>.SuccessResponse(response, "T?o blog thành công"));
        }
    ...
    int id,
            ...
            [FromForm] List<IFormFile>? files)
        {
            ...
            {
                return Unauthorized(ApiResponse<string>.ErrorResponse(
                    new List<string> { "Không xác d?nh du?c ngu?i dùng ho?c vai trò" },
                    "C?p nh?t th?t b?i"
                ));
            }
            ...
            try
            {
                ...
                return Ok(ApiResponse<BlogResponse>.SuccessResponse(response, "C?p nh?t blog thành công"));
            }
            catch (Exception ex)
            {
                await transaction.RollbackAsync(); 
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            {
                return NotFound(ApiResponse<string>.ErrorResponse(
                    new List<string> { "Không tìm th?y blog ho?c b?n không có quy?n xóa" },
                    "Xóa th?t b?i"
                ));
            }
